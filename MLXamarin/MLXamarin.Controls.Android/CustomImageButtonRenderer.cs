...
using WidgetButton = Android.Widget.Button;
...
{
    //https://github.com/XLabs/Xamarin-Forms-Labs/blob/master/src/Forms/XLabs.Forms.Droid/Controls/ImageButton/ImageButtonRenderer.cs
    public class CustomImageButtonRenderer : ButtonRenderer
    {
        ...
        /// </summary>
        private CustomImageButton ImageButton => (CustomImageButton)Element;
        ...
        protected override async void OnElementChanged(ElementChangedEventArgs<Button> e)
        {
            ...
            if (Element != null)
            {
                if (Element.Font != Font.Default && targetButton != null)
                ...
                if (!string.IsNullOrEmpty(Element.Text) && targetButton != null)
                    targetButton.Text = Element.Text;
            }
        }
        ...
        private async Task SetImageSourceAsync(WidgetButton targetButton, CustomImageButton model)
        {
        ...
        /// <summary>
        /// Gets a <see cref="Bitmap"/> for the supplied <see cref="Xamarin.Forms.ImageSource"/>.
        /// </summary>
        /// <param name="source">The <see cref="Xamarin.Forms.ImageSource"/> to get the image for.</param>
