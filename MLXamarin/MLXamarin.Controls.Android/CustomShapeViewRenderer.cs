...
[assembly: ExportRenderer(typeof(CustomShapeView), typeof(CustomShapeViewRenderer))]
namespace MLXamarin.Controls.Android
{
    public class CustomShapeViewRenderer : ViewRenderer<CustomShapeView, Shape>
    {
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<CustomShapeView> e)
        {
    ...
    public class Shape : View
    {
        ...
        public CustomShapeView ShapeView { get; set; }
