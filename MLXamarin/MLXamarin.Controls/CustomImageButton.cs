...
namespace MLXamarin.Controls
{
    ...
    public class CustomImageButton : Button
    {
        ...
        public static readonly BindableProperty SourceProperty = BindableProperty.Create("Source", typeof(ImageSource), typeof(CustomImageButton), null, BindingMode.OneWay, null, (bindable, value, newValue) => ((VisualElement)bindable).ToString());
        ...
        #region DisabledSourceProperty

        public static readonly BindableProperty DisabledSourceProperty = BindableProperty.Create("DisabledSource", typeof(ImageSource), typeof(CustomImageButton), null, BindingMode.OneWay, null, (bindable, oldvalue, newvalue) => ((VisualElement)bindable).ToString());
        ...
        #region ImageWidthRequestProperty

        public static readonly BindableProperty ImageWidthRequestProperty = BindableProperty.Create("ImageWidthRequest", typeof(int), typeof(CustomImageButton), default(int));
        ...
        #region ImageHeightRequestProperty

        public static readonly BindableProperty ImageHeightRequestProperty = BindableProperty.Create("ImageHeightRequest", typeof(int), typeof(CustomImageButton),default(int));
        ...
        public static readonly BindableProperty OrientationProperty = BindableProperty.Create("Orientation", typeof(ImageOrientation), typeof(CustomImageButton), ImageOrientation.ImageToLeft);
        ...
        #region ImageTintColorProperty

        public static readonly BindableProperty ImageTintColorProperty = BindableProperty.Create("ImageTintColor", typeof(Color), typeof(CustomImageButton), Color.Transparent);
        ...
        #region DisabledImageTintColorProperty

        public static readonly BindableProperty DisabledImageTintColorProperty = BindableProperty.Create("DisabledImageTintColor", typeof(Color), typeof(CustomImageButton), Color.Transparent);
