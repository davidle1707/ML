...
namespace DiscountWatchStore.Console
{
    public partial class FormMain : Form
    {
        ...
        private bool GetDataFeeds(ref List<DataFeed> feeds)
        {
            ...
            rtbReport.AppendText(Environment.NewLine + $"--- Brands: {string.Join(", ", selectedBrandKeys)}");
        ...
        {
            cmsBrands.SetItems(DiscountWatchStoreManager.Brands.OrderBy(b => b.Name).Select(b => new SelectItem { Name = b.Name, Value = b.Name, Selected = true }).ToList());
        }
